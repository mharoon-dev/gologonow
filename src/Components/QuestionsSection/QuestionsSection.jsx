  ...
  const questions = [
    {
      ...
      details:
        "UXD Consults does not take it lightly; instead, we Strive for success! Whether it's a basic landing page, a website, a web application, a mobile application, or a software solution, we can meet your demands using a wide selection of platforms and languages, including WordPress, Shopify, Wix, Weebly, Squarespace, and others. We design and develop Mobile Applications using a variety of innovative methods to generate Native, Hybrid, and Cross-Platform applications.",
    },
    {
      number: "02",
      name: "APP DEVELOPMENT",
      details:
        "UXD Consults is a leading mobile app development company operating in the USA, UAE, Pakistan, and internationally. We Provide extensive customization and functionality leveraging Android’s broad reach and flexibility to enhance ROI. We are able to us Reac Native to deliver apps that work seamlessly across Android, iOS, and Windows, ensuring efficiency and consistency. We Offer customized web applications with potentia integration of hybrid and VR/AR features. ",
    },
    {
      number: "03",
      name: "UI/UX",
      details:
        "UXD Consults thrive at the intersection of design and business through our UI UX design services and craft beautiful and functional experiences that can be launched quickly. We tackle difficult problem statements and transform them into meaningful experiences. ",
    },
    {
      number: "04",
      name: "ANIMATIONS",
